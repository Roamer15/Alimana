...
export class InitSchema1751730679151 implements MigrationInterface {
  name = 'InitSchema1751730679151';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."inventory_movements_source_type_enum" AS ENUM('Sale', 'PurchaseOrder', 'CustomerReturn', 'SupplierReturn', 'DamageReport', 'ManualAdjustment', 'Transfer')`,
    );
    await queryRunner.query(
      `CREATE TABLE "inventory_movements" ("id" SERIAL NOT NULL, "store_id" integer NOT NULL, "product_id" integer NOT NULL, "quantity" numeric(10,2) NOT NULL, "type" "public"."inventory_movements_type_enum" NOT NULL, "movement_type" "public"."inventory_movements_movement_type_enum" NOT NULL, "source_id" integer, "source_type" "public"."inventory_movements_source_type_enum", "created_at" TIMESTAMP NOT NULL DEFAULT now(), "create_by_id" integer NOT NULL, "notes" text, "created_by" integer NOT NULL, CONSTRAINT "PK_d7597827c1dcffae889db3ab873" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "Roles" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" character varying(255), "is_default" boolean NOT NULL DEFAULT false, "store_id" integer NOT NULL, "created_by_user_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "storeId" integer, "createdByUserId" integer, CONSTRAINT "PK_efba48c6a0c7a9b6260f771b165" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "expenses" ("id" SERIAL NOT NULL, "store_id" integer NOT NULL, "amount" numeric(12,2) NOT NULL, "description" character varying(255) NOT NULL, "category" character varying(100) NOT NULL, "date" date NOT NULL, "created_by" integer, "reference" character varying(100), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_94c3ceb17e3140abc9282c20610" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "audit_logs" ("id" SERIAL NOT NULL, "store_id" integer, "store_user_id" integer NOT NULL, "action_type" "public"."audit_logs_action_type_enum" NOT NULL, "entity" character varying NOT NULL, "entity_id" character varying NOT NULL, "old_value" json, "new_value" json, "timestamp" TIMESTAMP NOT NULL DEFAULT now(), "ip_address" character varying(45), "user_agent" character varying(255), CONSTRAINT "PK_1bb179d048bbc581caa3b013439" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "full_name" character varying(100) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "can_create_store" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "user_refresh_tokens" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "token_hash" character varying(255) NOT NULL, "user_agent" character varying, "ip_address" character varying, "expires_at" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "revoked" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_c5f5cf35bd8aabd1ebe9bb13409" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "inventory_movements" ADD CONSTRAINT "FK_4a137ccc372acb73821c4dd3991" FOREIGN KEY ("created_by") REFERENCES "store_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ADD CONSTRAINT "FK_12dfd9c89fa89fcec69df1d39ea" FOREIGN KEY ("store_user_id") REFERENCES "store_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sales" ADD CONSTRAINT "FK_ef0e802924109a86947d4df5c9e" FOREIGN KEY ("storeId") REFERENCES "stores"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sales" ADD CONSTRAINT "FK_b499133d93f00504df0aeccfc23" FOREIGN KEY ("cashSessionId") REFERENCES "cash_register_sessions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Roles" ADD CONSTRAINT "FK_65a67a962975766c88fa4a647c1" FOREIGN KEY ("storeId") REFERENCES "stores"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "Roles" ADD CONSTRAINT "FK_3c468f0a6588afac17234822a8a" FOREIGN KEY ("createdByUserId") REFERENCES "store_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "Roles" DROP CONSTRAINT "FK_3c468f0a6588afac17234822a8a"`);
    await queryRunner.query(`ALTER TABLE "Roles" DROP CONSTRAINT "FK_65a67a962975766c88fa4a647c1"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "products" DROP CONSTRAINT "FK_12dfd9c89fa89fcec69df1d39ea"`,
    );
    await queryRunner.query(
