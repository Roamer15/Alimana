...
export class InitiaSchema1753842248557 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "cash_register_sessions" ("id" SERIAL NOT NULL, "store_id" integer NOT NULL, "opened_by_id" integer NOT NULL, "closed_by_id" integer, "opened_at" TIMESTAMP NOT NULL, "closed_at" TIMESTAMP, "initial_cash" numeric(12,2) NOT NULL DEFAULT '0', "closing_cash" numeric(12,2), "expected_cash" numeric(10,2), "discrepancy" numeric(10,2), "status" "public"."cash_register_sessions_status_enum" NOT NULL DEFAULT 'open', "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "cash_register_id" integer, CONSTRAINT "PK_a852ffb1595560317cd41a2dcf5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "sale-receipts" ("id" SERIAL NOT NULL, "sale_id" integer NOT NULL, "store_id" integer NOT NULL, "type" "public"."sale-receipts_type_enum" NOT NULL DEFAULT 'original', "content" text, "receipt_number" character varying(100), "generated_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c2a03a5a48abfb204e909901263" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "sales" ("id" SERIAL NOT NULL, "store_id" integer NOT NULL, "created_by_id" integer NOT NULL, "cash_register_session_id" integer, "sale_number" character varying(50) NOT NULL, "total_amount" numeric(10,2) NOT NULL, "total_paid_amount" numeric(10,2) NOT NULL DEFAULT '0', "change_due" numeric(10,2) NOT NULL DEFAULT '0', "discount" numeric(10,2) NOT NULL DEFAULT '0', "status" "public"."sales_status_enum" NOT NULL DEFAULT 'completed', "is_refunded" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_4ef0fb3b23e3a0bdc11514270aa" UNIQUE ("sale_number"), CONSTRAINT "PK_4f0bc990ae81dba46da680895ea" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "payments" ("id" SERIAL NOT NULL, "sale_id" integer NOT NULL, "payment_method_id" integer NOT NULL, "amount" numeric(10,2) NOT NULL, "transaction_reference" character varying(100), "processed_by_store_user_id" integer NOT NULL, "status" "public"."payments_status_enum" NOT NULL DEFAULT 'completed', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "processed_by_id" integer, CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "stores" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "address" character varying(255), "phone" character varying(50), "email" character varying(255), "logo_url" character varying(255), "website_url" character varying(255), "profile_image_url" character varying(255), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "owner_id" integer NOT NULL, CONSTRAINT "PK_7aa6e7d71fa7acdd7ca43d7c9cb" PRIMARY KEY ("id"))`,
    );
